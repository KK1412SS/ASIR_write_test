...
class AISRClient:
    ...
    def upload_image(self, image_path, flipp):
        ...
        with Image.open(image_path) as img:
            ...
            #    flipped_path = os.path.join(tem_dir, f"flipped_{os.path.basename(image_path)}")
            #    flipped_img.save(flipped_path)
            #    print("flipped iamges ist saved")
...
def main():
    ...
    # 要上传的图片路径
    image_path = "./11.jpg"  # 替换为您的图片路径
    flipp = True  # for flipp image change to TRUE
