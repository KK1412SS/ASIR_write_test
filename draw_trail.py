...
def compensate_vertical_tilt(x_img, y_img, y_center=70.0, tilt_factor=-0.026):
    """
    Korrigiert die vertikale Schieflage direkt in der Trajectory.
    Bei deinem Mapping beeinflusst x_img die hoch/runter-Richtung.
    """
...
def uarm_draw(file):
        ...
        for l in file:
            ...
            x_img, y_img = compensate_vertical_tilt(
                x_img,
                y_img,
                y_center=70.0,
                tilt_factor= -0.026
        ...
        horizontal_center = (-0.35 + -0.15) / 2.0  # = -0.25
        horizontal_tilt_factor = -0.04
        ...
        for i in range(len(raw_p)):
            ...
            # 2. horizontale Tilt-Korrektur
            # x ist bei deinem Mapping hoch/runter
            # y ist bei deinem Mapping links/rechts
            x = x + horizontal_tilt_factor * (y - horizontal_center)
